...
- **매핑 형태**\
  ...
  - **Reobf**\
    Reobfuscated (รีอ็อบ), ที่เรียกว่า Spigot แมพพิ้งก์ และใช้ในส่วนมากของปลัักอิน NMS ครับ\
    จะหยุดใช้ตั้งแต่เวอร์ชัน 1.20.5
  - **Mojmap**\
    Mojang-mapped, เป็นแมพพิ้งก์ของ Minecraft รุ่นพื้นฐาน
- **버전 관리자**\
