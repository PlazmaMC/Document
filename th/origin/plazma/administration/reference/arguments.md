...
ในบางทีมินัลเตอร์เช่น Windows Powershell อาจไม่ยอมรับอาร์กิวเมนต์เหล่านี้ดังนั้น คุณจำเป็นต้องเพิ่ม `"` ที่ขอบของอาร์กิวเมนต์ [ต่อไปนี้](#user-content-fn-4)[^4]
