...
- **نوع التعيين**
  ...
  - **Reobf**\
    Reobfuscated (재난독화), Spigot مسحوبة مرة أخرى والمعروفة أيضًا بتسمية Spigot Mapping تُستخدم في معظم إضافات NMS.\
    سيتم إيقاف استخدامها اعتبارًا من الإصدار 1.20.5.
  - **Mojmap**\
    مُعدلة من قِبل Mojang، وهي تعني تعيين Minecraft الأصلي.
- **مدير الإصدار**
