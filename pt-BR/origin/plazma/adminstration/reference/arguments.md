...
### Alterar as propriedades do sistema pode modificar o funcionamento do Plazma e do JVM, podendo impactar significativamente o jogo!

Se não entender claramente o papel de cada propriedade do sistema, **não as utilize de forma alguma!**
{% endhint %}
...
### As plataformas de servidor da série Paperweight incluem um ponto `.` no nome da propriedade para distinguir as propriedades do sistema entre as plataformas.

Em alguns terminais como o Windows Powershell, pode ser necessário adicionar `"` nas extremidades dos argumentos para aceitá-los. [Adicionar.](#user-content-fn-4)[^4]
{% endhint %}
...
### Como o comando `/reload` é muito instável, todos os problemas que ocorrerem no servidor após seu uso são de responsabilidade do usuário.
...
### Isso pode permitir que o JVM acesse código inexistente!
...
### Essa propriedade será movida para os argumentos iniciais após o 1.20.5.
