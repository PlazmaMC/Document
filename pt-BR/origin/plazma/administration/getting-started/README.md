...
Se for exibido como abaixo, pule para [Etapa 2](#id-2).
...
Se não for exibido como acima, ou se for exibido como abaixo, significa que o JRE está ausente ou muito desatualizado, então você deve realizar a [Etapa 1.2](#id-1.2).
...
Neste manual, usamos o Azul Zulu como uma das [tipos de JRE](#user-content-fn-5)[^5].

Após a conclusão da instalação, verifique se a instalação foi concluída corretamente realizando novamente a [Etapa 1.1](#id-1.1).
...
O conteúdo abaixo é para aqueles interessados em desenvolvedores ou características específicas.\
Se você for um usuário comum, pule para a [Etapa 3](#id-3) sem problemas.
...
**Este manual pressupõe que você está usando o sistema operacional Windows e um roteador que pode usar [UPnP](#user-content-fn-12)[^12].**
