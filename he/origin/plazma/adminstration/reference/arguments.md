...
### שינוי במאפייני המערכת עשוי לשנות את הפעולה של Plazma והJVM, ולגרום לשינויים גדולים במשחק!

אם לא ברור לך איזה תפקיד יש לכל מאפיין מערכת, **אל תשתמש בהם!**
{% endhint %}
...
### פלטפורמת השרתים בסדרת Paperweight מפרידה בין מאפייני מערכת באמצעות הכלול של `.` בשם המאפיין.

בחלק מהטרמינלים כמו ב־Windows Powershell ייתכן שלא יאפשרו כניסה של ארגומנטים כאלו, ולכן עליך להוסיף `"` בקצוות הארגומנט. [^4]
{% endhint %}
...
### מחדש הוא פקודה לא יציבה מאוד, לכן כל בעיה שתתרחש אחרי השימוש בה תהיה באחריות המשתמש בלבד.
...
### כך תאפשר גישה של JVM לקוד שאינו קיים!
...
### תכונה זו תועבר לפרמטר פתיחה מתחילת גרסה 1.20.5.
...
### ארגומנט זה הופסק לשימוש מאז 1.19.4
