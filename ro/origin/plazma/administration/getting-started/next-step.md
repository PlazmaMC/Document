...
[Pentru detalii suplimentare, consultați `Referințe > Argumente și Proprietăți`](../reference/arguments.md#safemode)
...
Plazma are multe patch-uri de optimizare aplicate. De asemenea, atunci când Plazma este pornit pentru prima dată, va optimiza automat configurarea, deci nu este necesară nicio optimizare suplimentară dacă urmați instrucțiunile din [Începând](./README.md)

Cu toate acestea, atunci când se conectează mulți jucători sau când dimensiunea lumii este mare, puteți efectua optimizări suplimentare urmărind instrucțiunile de mai jos.
