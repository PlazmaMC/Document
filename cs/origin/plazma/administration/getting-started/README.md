...
Pomocí [Flags.sh](https://flags.sh) můžete vytvořit spouštěcí skript [zde](#user-content-fn-7)[^7]. Stačí zadat pouze paměť, kterou chcete použít v Plazma, a příkaz se automaticky optimalizuje.
...
Pokud nesouhlasíte, nemůžete spustit server a porušení EULA může vést k [sankcím](#user-content-fn-11)[^11], jako je pozastavení účtu.
