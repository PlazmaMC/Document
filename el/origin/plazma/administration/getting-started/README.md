...
- **매핑 형태**\
  ...
  - **Mojmap**\
    Χαρτογραφημένο από την Mojang, είναι το mapping του κανονικού Minecraft. 1.20.6 이후의 모던 플러그인에서 사용합니다.
- **버전 관리자**\
...
Δείτε το παρακάτω εγχειρίδιο για να μάθετε πώς να εξατομικεύσετε τον διακομιστή.
