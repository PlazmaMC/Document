...
- **매핑 형태**\
  ...
  - **Reobf**\
    Reobfuscated (ανανεωμένο), επίσης γνωστό ως Spigot mapping και χρησιμοποιείται σε πολλά NMS plugins.\
    Αναμένεται να σταματήσει η χρήση του από την έκδοση 1.20.5.
  - **Mojmap**\
    Χαρτογραφημένο από την Mojang, είναι το mapping του κανονικού Minecraft.
- **버전 관리자**\
