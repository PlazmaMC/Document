...
Αν εμφανιστεί όπως παρακάτω, πηδάτε στο [Βήμα 2](#id-2).
...
Αν δεν εμφανιστεί όπως παραπάνω, ή εμφανιστεί όπως παρακάτω, τότε είτε λείπει ο JRE είτε είναι πολύ παλιός, οπότε πρέπει να εκτελέσετε το [Βήμα 1.2](#id-1.2).
...
Σε αυτό το εγχειρίδιο χρησιμοποιούμε το Azul Zulu ως ένα από τα [είδη του JRE](#user-content-fn-5)[^5].

Μετά την ολοκλήρωση της εγκατάστασης, επαναλάβετε το [Βήμα 1.1](#id-1.1) για να επιβεβαιώσετε ότι η εγκατάσταση έχει ολοκληρωθεί σωστά.
...
Το παρακάτω περιεχόμενο είναι για όσους ενδιαφέρονται για τους προγραμματιστές ή τα χαρακτηριστικά κάθε τύπου.\
Αν είστε απλός χρήστης, μπορείτε να παραλείψετε το [Βήμα 3](#id-3) χωρίς πρόβλημα.
...
Μπορείτε να δημιουργήσετε ένα σενάριο εκκίνησης μέσω του [Flags.sh](https://flags.sh) για το Plazma, απλά εισάγοντας τη [μνήμη που θα χρησιμοποιηθεί](#user-content-fn-8)[^8]. Οι εντολές θα βελτιστοποιηθούν αυτόματα.
...
Σε περίπτωση μη συμφωνίας, δεν μπορείτε να ξεκινήσετε τον διακομιστή και μπορεί να υποστείτε [κυρώσεις](#user-content-fn-11)[^11] όπως αναστολή λογαριασμού λόγω παραβίασης της EULA.
...
Για τα Windows, καθώς η προστασία του τοίχου πυρασφάλειας έχει ενεργοποιηθεί στο [Βήμα 3](#id-3), απλά πρέπει να κάνετε port forwarding.

{% hint style="info" %}

**Αυτό το εγχειρίδιο υποθέτει ότι χρησιμοποιείτε τα Windows ως λειτουργικό σύστημα και ένα router που μπορεί να υποστηρίξει το [UPnP](#user-content-fn-12)[^12].**
