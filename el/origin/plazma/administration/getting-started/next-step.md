...
[Για περισσότερες λεπτομέρειες, ανατρέξτε στο `Αναφορές > Ορίσματα και Ιδιότητες`](../reference/arguments.md#safemode)
...
Το Plazma έχει εφαρμοστεί πολλά πακέτα βελτιστοποίησης. Επιπλέον, όταν η Plazma ξεκινάει για πρώτη φορά, βελτιστοποιεί αυτόματα τη διαμόρφωση, οπότε δεν χρειάζεται να κάνετε περαιτέρω βελτιστοποιήσεις αν ακολουθήσετε τις οδηγίες στο [Ξεκινώντας](./README.md)

Ωστόσο, όταν υπάρχει μεγάλος αριθμός παικτών συνδεδεμένων ή ο όγκος του κόσμου είναι μεγάλος, μπορείτε να κάνετε περαιτέρω βελτιστοποιήσεις ακολουθώντας τις οδηγίες παρακάτω.
