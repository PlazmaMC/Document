...
- **Mapping Type**\
  ...
  - **Reobf**\
    Reobfuscated, also known as Spigot mapping, used in most NMS plugins.\
    It will be deprecated starting from 1.20.5.
  - **Mojmap**\
    Mojang-mapped, the vanilla Minecraft mapping.
- **Version Manager**\
...
You can create a startup script through [Flags.sh](https://flags.sh) and automatically optimize the command by only entering the memory to use in Plazma.
