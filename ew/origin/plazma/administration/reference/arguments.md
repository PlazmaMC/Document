...
This is applied only to a degree that does not generally affect server performance and safety,
and configures to use vanilla defaults when `Plazma.disableConfigOptimization` property is used.
