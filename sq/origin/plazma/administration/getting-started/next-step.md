...
[Për më shumë informacion, shikoni `Referencat > Argumentet dhe Pronat`.](../reference/arguments.md#safemode)
...
Plazma ka shumë rregulla të optimizimit të aplikuar. Gjithashtu, kur Plazma fillon për herë të parë, optimizon konfigurimin automatikisht, kështu që nëse ndiqni udhëzuesin për [Fillimi](./README.md) nuk ka nevojë për veprime shtesë për optimizim.

Megjithatë, nëse ka shumë lojtarë që lidhen ose madhësia e botës është e gjerë, mund të bëni veprime shtesë për optimizim duke u bazuar në udhëzuesin më poshtë.
