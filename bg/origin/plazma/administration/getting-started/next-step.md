...
[Моля, прочетете `Референции > Аргументи и свойства` за подробности.](../reference/arguments.md#safemode)
...
Plazma има много оптимизационни пачове. Също така, когато Plazma се стартира за първи път, автоматично оптимизира конфигурацията си, така че ако следвате инструкциите в [Ръководството за започване](./README.md), няма нужда от допълнителни оптимизации.
