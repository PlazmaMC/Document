...
Началните променливи и системните свойства са стойности, които се добавят към [командите](#user-content-fn-1)[^1], използвани за стартиране на Plazma, които позволяват промяна на стойностите, които не могат да бъдат променени след стартирането на Plazma.

В зависимост от [местоположението на добавянето на команди](#user-content-fn-2)[^2], те се разделят на **начални аргументи** и **системни свойства**.
...
### Промяната на системните свойства може да промени начина на работа на Plazma и JVM и може да има сериозно въздействие върху играта!

Ако не сте напълно уверени каква е ролята на всяко системно свойство, **никога не го използвайте!**
{% endhint %}
...
Например, ако искате да приложите системното свойство `Plazma.dummyProperty`, следното въвеждане ще доведе до инициализиране на Plazma със стойност `37` за това свойство.
...
ако не се въведе стойност, тя се фиксира като [`true`.](#user-content-fn-3)[^3]

{% hint style="info" %}

### Платформите от серията Paperweight включват `.` в имената на своите свойства, за да разграничат системните свойства за всяка платформа.

В някои терминали като Windows Powershell може да не се позволява това, затова трябва да добавите `"` в началото и края на аргумента.[^4]
{% endhint %}
...
### Понеже командата `/reload` е много нестабилна, всички проблеми, възникнали след нейното изпълнение, са отговорност на потребителя.
...
Деактивира ограничението на броя канали на плъгин за всеки играч до 128.[^5]
...
Задава ограничение за имената на плъгин каналите.[^6]
...
Обикновено играта[^7] продължава да изпраща [сигнали на сърцето](#user-content-fn-8)[^8] към сървъра, така че не бива да бъдете изгонени, но,]\(#user-content-fn-9)[^9] ако играта не отговаря, тя се счита за сблъсък и сървърът спира да обработва играчите и ги изгонва.
...
### Това свойство ще бъде преместено като начален аргумент след версия 1.20.5.
...
Подтискане на предупреждението[^11], което се извежда при инициализиране на Plazma.
...
### Този аргумент е спрян след версия 1.19.4
