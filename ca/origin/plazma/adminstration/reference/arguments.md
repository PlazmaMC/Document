...
En algunes terminals com Windows Powershell, pot ser que no s'acceptin aquests arguments, per la qual cosa cal afegir `"` als extrems dels arguments.]\(#user-content-fn-4)[^4]
{% endhint %}
