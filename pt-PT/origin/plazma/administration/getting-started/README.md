...
Se for exibido como abaixo, vá para [Etapa 2](#id-2).
...
Se não for exibido como acima, ou se for exibido como abaixo, significa que o JRE não está presente ou está muito desatualizado, portanto, você deve executar a [Etapa 1.2](#id-1.2).
...
Neste manual, usamos o Azul Zulu como [um dos tipos](#user-content-fn-5) do JRE.

Após a conclusão da instalação, verifique se a instalação foi concluída corretamente executando novamente a [Etapa 1.1](#id-1.1).
...
O conteúdo abaixo é para aqueles que estão interessados nos desenvolvedores ou nas características de cada tipo.\
Se você for um usuário comum, pule para [Etapa 3](#id-3) sem problemas.
...
Para o Windows, como o firewall foi permitido na [Etapa 3](#id-3), basta fazer o encaminhamento de porta.

{% dica estilo="info" %}

**Este manual pressupõe que você está usando o sistema operacional Windows e um roteador que pode usar [UPnP](#user-content-fn-12).**
