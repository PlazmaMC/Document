...
Плазма има многе патчеве за оптимизацију. Такође, када се Plazma први пут покрене, он ће аутоматски
оптимизовати конфигурацију, тако да нема потребе за додатним оптимизацијама ако пратите упутства у [Упутству за почетак](./README.md).

Међутим, ако се повелики број играча прикључи или је величина света велика,
можете извршити додатне оптимизације пратећи упутства у доле наведеном упутству.
