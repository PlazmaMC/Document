...
Када се прикаже следеће, прескочите на [корак 2](#id-2).
...
Ако се не прикаже како је наведено или ако се прикаже као што је наведено испод, то значи да нема JRE или је превише стар, па морате извршити [корак 1.2](#id-1.2).
...
У овом упутству користимо Azul Zulu као један од [типова JRE](#user-content-fn-5)[^5].

Након што завршите инсталацију, поновите [корак 1.1](#id-1.1) да бисте проверили да ли је инсталација успешно завршена.
...
Следећи садржај је намењен онима који су зантересовани за програмере или различите аспекте.\
Ако сте обичан корисник, можете прескочити на [корак 3](#id-3) без проблема.
...
[Flags.sh](https://flags.sh)можете да користите за креирање почетног скрипта [генерисање](#user-content-fn-7)[^7].\
Само унесите количину меморије коју желите да користите у Plazmi и команда ће се аутоматски оптимизовати.
...
Уколико не се слажете, нећете моћи да покренете сервер и можете бити подложни [казни](#user-content-fn-11)[^11] као што је привремена суспензија налога у случају кршења EULA.
...
За Windows, јер је заштитни зид дозвољен у [кораку 3](#id-3), само је потребно направити преусмеравање порта.

{% hint style="info" %}

**Ово упутство претпоставља да користите Windows оперативни систем и рутер који може користити [UPnP](#user-content-fn-12)[^12].**
