...
Hvis det vises som følger, hopper du til [trinn 2](#id-2).
...
Hvis det ikke vises som beskrevet ovenfor, eller hvis det vises som beskrevet nedenfor, må du utføre [trinn 1.2](#id-1.2) fordi JRE enten mangler eller er for gammel.
...
I denne veiledningen bruker vi Azul Zulu som en av JRE [typene](#user-content-fn-5)[^5].

Etter at installasjonen er fullført, gjenta [trinn 1.1](#id-1.1) for å bekrefte at installasjonen ble fullført riktig.
...
Følgende informasjon er for de som er nysgjerrige på utviklere eller egenskapene til ulike former.\
Hvis du er en vanlig bruker, kan du hoppe over til [trinn 3](#id-3) uten problemer.
...
For Windows-brukere, siden brannmuren er tillatt i [trinn 3](#id-3), trenger du bare å konfigurere portvideresending.

{% hint style="info" %}

**Denne veiledningen er skrevet med tanke på Windows-operativsystemet og en ruter som kan bruke [UPnP](#user-content-fn-12)[^12].**
