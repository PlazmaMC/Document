...
Plazma의 강력한 플러그인 생태계는 관리자가 손 쉽게 서버를 사용자화 할 수 있게 합니다.

플러그인은 [SpigotMC Forum](https://www.spigotmc.org/resources/), [BukkitDev](https://dev.bukkit.org/bukkit-plugins), [Modrinth](https://modrinth.com/plugins), [Hanger](https://hangar.papermc.io/) 등에서 다운로드 할 수 있습니다.
