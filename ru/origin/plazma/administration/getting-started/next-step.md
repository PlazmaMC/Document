...
[Для получения более подробной информации смотрите `Справка > Аргументы и свойства`](../reference/arguments.md#safemode)
...
Plazma содержит множество патчей оптимизации. Кроме того, когда Plazma запускается впервые, она автоматически
оптимизирует конфигурацию, поэтому если вы следуете инструкциям в [Руководстве по началу работы](./README.md), дополнительных оптимизаций не потребуется.

Однако, если много игроков подключено или размер мира огромен,
вы можете выполнить дополнительные оптимизации, следуя инструкциям в данном руководстве.
