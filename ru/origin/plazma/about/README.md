...
4. **Безопасный игровой сервер**\
   [No Chat Reports](https://github.com/Aizistral-Studios/No-Chat-Reports) включает в себя возможность отключения [системы жалоб на чат](#user-content-fn-3)[^3] от [Mojang](#user-content-fn-2)[^2], добавленную с версии 1.19, и полное удаление сборщика диагностической информации, что позволяет играть на сервере без отслеживания.
