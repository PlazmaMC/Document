...
4. **Veilig spelen op een server**\
   [Geen Chatrapporten](https://github.com/Aizistral-Studios/No-Chat-Reports) is opgenomen, waardoor vanaf 1.19 het [Mojang](#user-content-fn-2)[^2] [chatrapportsysteem](#user-content-fn-3)[^3] kan worden uitgeschakeld, en de diagnostische gegevensverzamelaar volledig wordt verwijderd, waardoor je op een server kunt spelen zonder tracking.
5. **Snelste updates**\
