...
- **Форма картування**\
  ...
  - **Reobf**\
    Reobfuscation, також відомий як Spigot Mapping, використовується в більшості NMS плагінів.\
    Планується припинення використання з версії 1.20.5.
  - **Mojmap**\
    Mojang Mapping, мапування Vanilla Minecraft.
- **Менеджер версій**\
