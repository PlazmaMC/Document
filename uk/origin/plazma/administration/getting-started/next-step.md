...
[Для отримання детальної інформації див. `Референції > Аргументи та властивості`](../reference/arguments.md#safemode)
...
У Plazma застосовано багато патчів для оптимізації. Крім того, при першому запуску Plazma автоматично
оптимізує конфігурацію, тому якщо ви дотримуєтеся інструкцій у [Посібнику з запуску](./README.md), додаткових оптимізацій не потрібно виконувати.

Проте, у випадку багатьох гравців або великих розмірів світу,
ви можете виконати додаткові оптимізації, дотримуючись інструкцій у цьому посібнику.
