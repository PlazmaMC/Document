...
[বিস্তারিত জানতে `রেফারেন্স > আর্গুমেন্ট এবং প্রোপার্টি` দেখুন।](../reference/arguments.md#safemode)
...
Plazma에는 많은 최적화 패치가 적용되어 있습니다. এছাড়াও, Plazma প্রথম বার চালু করলে স্বয়ংক্রিয়ভাবে
কনফিগারেশন অপটিমাইজ করে তাই [শুরু করুন](./README.md) বর্ণিত মার্গানুযায়ী অতিরিক্ত অপটিমাইজেশন করার প্রয়োজন হয়না।

তবে, যদিও অনেক গেমার যোগাযোগ করে বা, বিশাল এলাকার বিশ্বের ক্ষেত্রে,
নীচের মার্গানুযায়ী অতিরিক্ত অপটিমাইজেশন করা যেতে পারে।
