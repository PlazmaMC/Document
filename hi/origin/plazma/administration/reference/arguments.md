...
각 시스템 속성이 어떠한 역할을 하는지 확실히 알지 못하는 경우, **अवश्य उपयोग न करें!**
...
Windows Powershell और अन्य कुछ टर्मिनल में यह प्रार्थना अनुमोदित नहीं हो सकती है, इसलिए, इसे इनपुट के दोनों ओर `"` जोड़ना [आवश्यक](#user-content-fn-4)[^4] है।
...
प्रत्येक प्लेयर के लिए 128 प्लगइन [चैनल](#user-content-fn-5)[^5] की संख्या सीमा को निषेधित करता है।
...
सामान्यतः, [गेम](#user-content-fn-7)[^7] सर्वर को निरंतर [हार्टबीट सिग्नल](#user-content-fn-8)[^8] भेजता है, इसलिए, [निकाला नहीं जाता,](#user-content-fn-9)[^9] लेकिन, अगर गेम जवाब नहीं देता है तो गेम को टकराया माना जाता है और अब सर्वर से उस खिलाड़ी का निपटान करना बंद कर देता है।
...
प्लाज्मा को आरंभ करते समय प्रकट होने वाले [चेतावनी संदेश](#user-content-fn-11)[^11] को दबाता है।
...
**यह गुणवत्ता अभी विकसित हो रही है।**

{% endhint %}

{% hint style="danger" %}

**यह गुणवत्ता सभी सुरक्षा दोषों को पूर्ववत करती है!**
...
यह मुख्य रूप से सर्वर प्रदर्शन और सुरक्षा पर केवल ज्यादा प्रभाव नहीं डालता है, और
`Plazma.disableConfigOptimization` गुणवत्ता का प्रयोग करने पर वनिला डिफ़ॉल्ट का उपयोग करता है।
...
**यह अभिलेख 1.19.4 के बाद से बंद कर दिया गया है**
